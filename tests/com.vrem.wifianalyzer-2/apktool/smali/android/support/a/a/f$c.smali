...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/a/a/f$c;->d:Landroid/graphics/Matrix;
    ...
    iput v1, p0, Landroid/support/a/a/f$c;->b:F

    iput v1, p0, Landroid/support/a/a/f$c;->e:F

    iput v1, p0, Landroid/support/a/a/f$c;->f:F

    iput v2, p0, Landroid/support/a/a/f$c;->g:F

    iput v2, p0, Landroid/support/a/a/f$c;->h:F

    iput v1, p0, Landroid/support/a/a/f$c;->i:F

    iput v1, p0, Landroid/support/a/a/f$c;->j:F

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroid/support/a/a/f$c;->k:Landroid/graphics/Matrix;
...
.method public constructor <init>(Landroid/support/a/a/f$c;Landroid/support/v4/g/a;)V
    ...
    iget v0, p1, Landroid/support/a/a/f$c;->b:F

    iput v0, p0, Landroid/support/a/a/f$c;->b:F
    ...
    iget v0, p1, Landroid/support/a/a/f$c;->j:F

    iput v0, p0, Landroid/support/a/a/f$c;->j:F
    ...
    iget v0, p1, Landroid/support/a/a/f$c;->c:I

    iput v0, p0, Landroid/support/a/a/f$c;->c:I
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/a/a/f$c;->k:Landroid/graphics/Matrix;

    iget-object v1, p1, Landroid/support/a/a/f$c;->k:Landroid/graphics/Matrix;
...
.method static synthetic a(Landroid/support/a/a/f$c;)Landroid/graphics/Matrix;
    .locals 1

    iget-object v0, p0, Landroid/support/a/a/f$c;->d:Landroid/graphics/Matrix;
...
.method private a()V
    ...
    iget v1, p0, Landroid/support/a/a/f$c;->g:F
    ...
    iget v1, p0, Landroid/support/a/a/f$c;->b:F

    invoke-virtual {v0, v1, v3, v3}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    iget-object v0, p0, Landroid/support/a/a/f$c;->k:Landroid/graphics/Matrix;

    iget v1, p0, Landroid/support/a/a/f$c;->i:F

    iget v2, p0, Landroid/support/a/a/f$c;->e:F

    add-float/2addr v1, v2

    iget v2, p0, Landroid/support/a/a/f$c;->j:F

    iget v3, p0, Landroid/support/a/a/f$c;->f:F
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget v2, p0, Landroid/support/a/a/f$c;->b:F
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/a/a/f$c;->a()V
...
.method public a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p3, p2, v0}, Landroid/support/a/a/e;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method public getPivotX()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->e:F
...
.method public getPivotY()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->f:F
...
.method public getRotation()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->b:F
...
.method public getScaleX()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->g:F
...
.method public getScaleY()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->h:F
...
.method public getTranslateX()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->i:F
...
.method public getTranslateY()F
    ...
    iget v0, p0, Landroid/support/a/a/f$c;->j:F
...
.method public setPivotX(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->e:F
...
.method public setPivotY(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->f:F
...
.method public setRotation(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->b:F
...
.method public setScaleX(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->g:F
...
.method public setScaleY(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->h:F
...
.method public setTranslateX(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->i:F
...
.method public setTranslateY(F)V
    ...
    iput p1, p0, Landroid/support/a/a/f$c;->j:F
