...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/be;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/be;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/be;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/be;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/be;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v6, p1, v3, p2, v2}, Landroid/support/v7/widget/bg;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bg;

    move-result-object v3

    sget v4, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_textAppearance:I

    invoke-virtual {v3, v4, v8}, Landroid/support/v7/widget/bg;->g(II)I

    move-result v4

    sget v7, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_drawableLeft:I

    invoke-virtual {v3, v7}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    invoke-virtual {v3, v7, v2}, Landroid/support/v7/widget/bg;->g(II)I

    move-result v7

    invoke-static {v6, v0, v7}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/be;

    move-result-object v7

    iput-object v7, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/be;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/be;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/be;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/be;

    :cond_3
    invoke-virtual {v3}, Landroid/support/v7/widget/bg;->a()V
    ...
    invoke-static {v6, v4, v0}, Landroid/support/v7/widget/bg;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bg;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/support/v7/widget/bg;->a(IZ)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/bg;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    invoke-virtual {v8, v5}, Landroid/support/v7/widget/bg;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v5

    :cond_4
    :goto_2
    invoke-virtual {v8}, Landroid/support/v7/widget/bg;->a()V

    :goto_3
    sget-object v8, Landroid/support/v7/a/a$j;->TextAppearance:[I

    invoke-static {v6, p1, v8, p2, v2}, Landroid/support/v7/widget/bg;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bg;
    ...
    invoke-virtual {v6, v8}, Landroid/support/v7/widget/bg;->g(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/bg;->e(I)Landroid/content/res/ColorStateList;
