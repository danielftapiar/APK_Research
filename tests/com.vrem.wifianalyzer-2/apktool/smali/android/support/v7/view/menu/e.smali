...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/e;->l:Landroid/support/v7/widget/ap;
...
.method private c(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/e;->j()Landroid/support/v7/widget/aq;

    move-result-object v8

    invoke-virtual {v8, v0}, Landroid/support/v7/widget/aq;->a(Landroid/widget/ListAdapter;)V

    invoke-virtual {v8, v7}, Landroid/support/v7/widget/aq;->g(I)V

    iget v0, p0, Landroid/support/v7/view/menu/e;->n:I

    invoke-virtual {v8, v0}, Landroid/support/v7/widget/aq;->e(I)V
    ...
    invoke-virtual {v8, v2}, Landroid/support/v7/widget/aq;->b(Z)V

    invoke-virtual {v8, v4}, Landroid/support/v7/widget/aq;->a(Ljava/lang/Object;)V
    ...
    iget-object v10, v5, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v10}, Landroid/support/v7/widget/aq;->j()I
    ...
    iget-object v11, v5, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v11}, Landroid/support/v7/widget/aq;->k()I
    ...
    :goto_3
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/aq;->c(I)V

    invoke-virtual {v8, v1}, Landroid/support/v7/widget/aq;->d(I)V
    ...
    invoke-direct {v0, v8, p1, v1}, Landroid/support/v7/view/menu/e$a;-><init>(Landroid/support/v7/widget/aq;Landroid/support/v7/view/menu/h;I)V

    iget-object v1, p0, Landroid/support/v7/view/menu/e;->b:Ljava/util/List;

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v8}, Landroid/support/v7/widget/aq;->d()V
    ...
    invoke-virtual {v8}, Landroid/support/v7/widget/aq;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/aq;->d(I)V
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/aq;->a(Landroid/graphics/Rect;)V
...
.method private j()Landroid/support/v7/widget/aq;
    .locals 5
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/aq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroid/support/v7/view/menu/e;->l:Landroid/support/v7/widget/ap;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aq;->a(Landroid/support/v7/widget/ap;)V

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/aq;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/aq;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroid/support/v7/view/menu/e;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aq;->b(Landroid/view/View;)V

    iget v1, p0, Landroid/support/v7/view/menu/e;->n:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aq;->e(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aq;->a(Z)V
...
.method public a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object v1, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v1, v4}, Landroid/support/v7/widget/aq;->b(Ljava/lang/Object;)V

    iget-object v1, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v1, v3}, Landroid/support/v7/widget/aq;->b(I)V

    :cond_3
    iget-object v0, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v0}, Landroid/support/v7/widget/aq;->e()V
...
.method public e()V
    ...
    iget-object v3, v2, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v3}, Landroid/support/v7/widget/aq;->f()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v2}, Landroid/support/v7/widget/aq;->e()V
...
.method public f()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aq;->f()Z
...
.method public onDismiss()V
    ...
    iget-object v5, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v5}, Landroid/support/v7/widget/aq;->f()Z
