...
.field final p:Landroid/support/v4/h/ay;

.field final q:Landroid/support/v4/h/ay;

.field final r:Landroid/support/v4/h/ba;
...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v1, Landroid/support/v7/app/t;->v:Z
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/t;->z:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v7/app/t;->p:Landroid/support/v4/h/ay;
    ...
    iput-object v0, p0, Landroid/support/v7/app/t;->q:Landroid/support/v4/h/ay;
    ...
    iput-object v0, p0, Landroid/support/v7/app/t;->r:Landroid/support/v4/h/ba;

    iput-object p1, p0, Landroid/support/v7/app/t;->x:Landroid/app/Activity;
...
.method public constructor <init>(Landroid/app/Dialog;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/t;->y:Landroid/app/Dialog;
...
.method private a(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/t;->b(Landroid/view/View;)Landroid/support/v7/widget/ae;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/t;->d:Landroid/support/v7/widget/ae;
    ...
    iget-object v0, p0, Landroid/support/v7/app/t;->d:Landroid/support/v7/widget/ae;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Landroid/support/v7/app/t;->b(Z)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/app/t;->c(Z)V
...
.method private k(Z)V
    ...
    iget-object v3, p0, Landroid/support/v7/app/t;->g:Landroid/support/v7/widget/ay;

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ActionBarContainer;->setTabContainer(Landroid/support/v7/widget/ay;)V

    :goto_0
    invoke-virtual {p0}, Landroid/support/v7/app/t;->j()I
    ...
    invoke-static {v3}, Landroid/support/v4/h/ae;->w(Landroid/view/View;)V

    :cond_0
    :goto_2
    iget-object v4, p0, Landroid/support/v7/app/t;->d:Landroid/support/v7/widget/ae;
...
.method public a(F)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/h/ae;->f(Landroid/view/View;F)V
...
.method public a(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/ae;->d(I)V
...
.method public a(II)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/t;->d:Landroid/support/v7/widget/ae;
...
.method public b()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/t;->k()I

    move-result v0

    iget-boolean v1, p0, Landroid/support/v7/app/t;->H:Z

    if-eqz v1, :cond_1

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroid/support/v7/app/t;->d()I
...
.method public c()Landroid/content/Context;
    ...
    iget-object v0, p0, Landroid/support/v7/app/t;->w:Landroid/content/Context;
    ...
    iput-object v1, p0, Landroid/support/v7/app/t;->w:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/app/t;->w:Landroid/content/Context;
...
.method public d(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/t;->a(Z)V
...
.method public h(Z)V
    ...
    sget-boolean v0, Landroid/support/v7/app/t;->v:Z
    ...
    invoke-static {v2}, Landroid/support/v4/h/ae;->r(Landroid/view/View;)Landroid/support/v4/h/au;
    ...
    iget-object v3, p0, Landroid/support/v7/app/t;->r:Landroid/support/v4/h/ba;

    invoke-virtual {v2, v3}, Landroid/support/v4/h/au;->a(Landroid/support/v4/h/ba;)Landroid/support/v4/h/au;

    invoke-virtual {v1, v2}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/au;)Landroid/support/v7/view/h;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/h/au;->c(F)Landroid/support/v4/h/au;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/au;)Landroid/support/v7/view/h;
    ...
    iget-object v0, p0, Landroid/support/v7/app/t;->q:Landroid/support/v4/h/ay;

    invoke-virtual {v1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/ay;)Landroid/support/v7/view/h;
...
.method public i(Z)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/h/au;->c(F)Landroid/support/v4/h/au;
    ...
    iget-object v0, p0, Landroid/support/v7/app/t;->p:Landroid/support/v4/h/ay;
...
.method public j(Z)V
    ...
    invoke-direct {p0}, Landroid/support/v7/app/t;->p()V

    :goto_0
    invoke-direct {p0}, Landroid/support/v7/app/t;->r()Z
    ...
    invoke-interface {v0, v1, v4, v5}, Landroid/support/v7/widget/ae;->a(IJ)Landroid/support/v4/h/au;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v7/app/t;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v1, v2, v6, v7}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/h/au;
    ...
    invoke-virtual {v2, v0, v1}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/au;Landroid/support/v4/h/au;)Landroid/support/v7/view/h;
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v7/app/t;->q()V
    ...
    invoke-interface {v0, v2, v6, v7}, Landroid/support/v7/widget/ae;->a(IJ)Landroid/support/v4/h/au;

    move-result-object v1

    iget-object v0, p0, Landroid/support/v7/app/t;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v0, v3, v4, v5}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/h/au;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ae;->e(I)V
    ...
    invoke-interface {v0, v2}, Landroid/support/v7/widget/ae;->e(I)V
