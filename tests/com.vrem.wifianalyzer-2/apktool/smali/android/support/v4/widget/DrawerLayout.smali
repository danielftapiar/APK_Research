...
.field private final m:Landroid/support/v4/widget/DrawerLayout$i;

.field private final n:Landroid/support/v4/widget/DrawerLayout$i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$i;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$i;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$i;
    ...
    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$i;->a(Landroid/support/v4/widget/af;)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$i;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$i;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/af;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/DrawerLayout$i;->a(Landroid/support/v4/widget/af;)V

    invoke-virtual {p0, v4}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    invoke-static {p0, v4}, Landroid/support/v4/h/ae;->c(Landroid/view/View;I)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Landroid/support/v4/h/b;)V

    const/4 v1, 0x0

    invoke-static {p0, v1}, Landroid/support/v4/h/aq;->a(Landroid/view/ViewGroup;Z)V
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/h/ae;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    invoke-static {p2, v0}, Landroid/support/v4/h/f;->a(II)I
...
.method a(Z)V
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$i;

    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout$i;->a()V

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/DrawerLayout$i;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Landroid/support/v4/h/f;->a(II)I

    move-result v6

    invoke-static {v10}, Landroid/support/v4/h/ae;->x(Landroid/view/View;)Z
    ...
    invoke-static {v10}, Landroid/support/v4/h/ae;->t(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Landroid/support/v4/h/ae;->f(Landroid/view/View;F)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    instance-of v0, p1, Landroid/support/v4/widget/DrawerLayout$h;
    ...
    :cond_1
    check-cast p1, Landroid/support/v4/widget/DrawerLayout$h;

    invoke-virtual {p1}, Landroid/support/v4/widget/DrawerLayout$h;->a()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroid/view/ViewGroup;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$h;->a:I
    ...
    :cond_2
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$h;->b:I
    ...
    :cond_3
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$h;->c:I
    ...
    :cond_4
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$h;->e:I
    ...
    :cond_5
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$h;->f:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    new-instance v6, Landroid/support/v4/widget/DrawerLayout$h;

    invoke-direct {v6, v0}, Landroid/support/v4/widget/DrawerLayout$h;-><init>(Landroid/os/Parcelable;)V
    ...
    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$h;->a:I

    :cond_1
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->r:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$h;->b:I

    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->s:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$h;->c:I

    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$h;->e:I

    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->u:I

    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$h;->f:I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/h/ae;->f(Landroid/view/View;F)V
