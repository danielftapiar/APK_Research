...
.field private k:Landroid/support/design/widget/g;
...
.method private a(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/g$a;
    .locals 1
...
.method private a()Landroid/support/design/widget/g;
    .locals 3
    ...
    sget-object v2, Landroid/support/design/widget/x;->a:Landroid/support/design/widget/q$d;

    invoke-direct {v0, p0, v1, v2}, Landroid/support/design/widget/h;-><init>(Landroid/support/design/widget/z;Landroid/support/design/widget/m;Landroid/support/design/widget/q$d;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/design/widget/f;-><init>(Landroid/support/design/widget/z;Landroid/support/design/widget/m;Landroid/support/design/widget/q$d;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/design/widget/e;-><init>(Landroid/support/design/widget/z;Landroid/support/design/widget/m;Landroid/support/design/widget/q$d;)V
...
.method static synthetic a(Landroid/support/design/widget/FloatingActionButton;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-super {p0, p1}, Landroid/support/design/widget/z;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private getImpl()Landroid/support/design/widget/g;
    ...
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->k:Landroid/support/design/widget/g;

    if-nez v0, :cond_0

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->a()Landroid/support/design/widget/g;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->k:Landroid/support/design/widget/g;
...
.method a(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/g$a;

    move-result-object v1

    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/g;->b(Landroid/support/design/widget/g$a;Z)V
...
.method public a(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/h/ae;->F(Landroid/view/View;)Z
...
.method b(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    ...
    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/g;->a(Landroid/support/design/widget/g$a;Z)V
...
.method protected drawableStateChanged()V
    ...
    invoke-super {p0}, Landroid/support/design/widget/z;->drawableStateChanged()V
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/g;->f()Landroid/graphics/drawable/Drawable;
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-super {p0}, Landroid/support/design/widget/z;->jumpDrawablesToCurrentState()V

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/g;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/design/widget/g;->b()V
...
.method protected onAttachedToWindow()V
    ...
    invoke-super {p0}, Landroid/support/design/widget/z;->onAttachedToWindow()V

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/g;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/design/widget/g;->h()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-super {p0}, Landroid/support/design/widget/z;->onDetachedFromWindow()V

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/g;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/design/widget/g;->i()V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/g;->g()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/design/widget/z;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/g;->c()V
...
.method public bridge synthetic setVisibility(I)V
    ...
    invoke-super {p0, p1}, Landroid/support/design/widget/z;->setVisibility(I)V
