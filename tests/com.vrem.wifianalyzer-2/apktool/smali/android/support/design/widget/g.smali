...
.field final n:Landroid/support/design/widget/z;

.field final o:Landroid/support/design/widget/m;

.field final p:Landroid/support/design/widget/q$d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/g;->b:Landroid/view/animation/Interpolator;
...
.method constructor <init>(Landroid/support/design/widget/z;Landroid/support/design/widget/m;Landroid/support/design/widget/q$d;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/z;

    iput-object p2, p0, Landroid/support/design/widget/g;->o:Landroid/support/design/widget/m;

    iput-object p3, p0, Landroid/support/design/widget/g;->p:Landroid/support/design/widget/q$d;
...
.method private l()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/g;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iput-object v0, p0, Landroid/support/design/widget/g;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method final g()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/g;->o:Landroid/support/design/widget/m;
...
.method h()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/z;

    invoke-virtual {v0}, Landroid/support/design/widget/z;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Landroid/support/design/widget/g;->q:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method j()Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/g;->n:Landroid/support/design/widget/z;

    invoke-virtual {v2}, Landroid/support/design/widget/z;->getVisibility()I

    move-result v2

    if-eqz v2, :cond_2

    iget v2, p0, Landroid/support/design/widget/g;->c:I
