...
.field private static final f:Landroid/support/v4/g/i$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final h:Landroid/support/design/widget/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private u:Landroid/support/v4/h/bb;

.field private v:Z

.field private w:Landroid/graphics/drawable/Drawable;

.field private x:Landroid/support/v4/h/z;

.field private final y:Landroid/support/v4/h/y;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/v4/g/i$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/design/widget/d;
    ...
    new-instance v1, Landroid/support/v4/h/y;

    invoke-direct {v1, p0}, Landroid/support/v4/h/y;-><init>(Landroid/view/ViewGroup;)V

    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->y:Landroid/support/v4/h/y;
...
.method private static a(Landroid/graphics/Rect;)V
    ...
    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/v4/g/i$a;
...
.method private a(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$d;II)V
    ...
    invoke-static {v0, p2}, Landroid/support/v4/h/f;->a(II)I
    ...
    invoke-static {v1, p2}, Landroid/support/v4/h/f;->a(II)I
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-static {p1}, Landroid/support/v4/h/ae;->F(Landroid/view/View;)Z
    ...
    invoke-static {v2, p3}, Landroid/support/v4/h/f;->a(II)I
...
.method private b(Landroid/support/v4/h/bb;)Landroid/support/v4/h/bb;
    .locals 5

    invoke-virtual {p1}, Landroid/support/v4/h/bb;->f()Z
    ...
    invoke-static {v4}, Landroid/support/v4/h/ae;->x(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p0, v4, v1}, Landroid/support/design/widget/CoordinatorLayout$a;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/support/v4/h/bb;)Landroid/support/v4/h/bb;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v4/h/bb;->f()Z
...
.method private b(Landroid/view/View;II)V
    ...
    invoke-static {v1, p3}, Landroid/support/v4/h/f;->a(II)I
...
.method private c(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;
    ...
    invoke-static {p1}, Landroid/support/v4/h/ae;->x(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;

    invoke-virtual {v2}, Landroid/support/v4/h/bb;->a()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/bb;->b()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/bb;->c()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/bb;->d()I
    ...
    invoke-static/range {v0 .. v5}, Landroid/support/v4/h/f;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method private d(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/ae;->e(Landroid/view/View;I)V
...
.method private e(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/ae;->d(Landroid/view/View;I)V
...
.method private e(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/design/widget/d;

    invoke-virtual {v0, p1}, Landroid/support/design/widget/d;->e(Ljava/lang/Object;)Z
...
.method private g()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/widget/d;->a(Ljava/lang/Object;)V
    ...
    iget-object v6, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/design/widget/d;

    invoke-virtual {v6, v5}, Landroid/support/design/widget/d;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v6, v5}, Landroid/support/design/widget/d;->a(Ljava/lang/Object;)V

    :cond_2
    iget-object v6, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/design/widget/d;

    invoke-virtual {v6, v4, v5}, Landroid/support/design/widget/d;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/design/widget/d;

    invoke-virtual {v1}, Landroid/support/design/widget/d;->b()Ljava/util/ArrayList;
...
.method private h()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/z;
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/z;

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/z;

    invoke-static {p0, v0}, Landroid/support/v4/h/ae;->a(Landroid/view/View;Landroid/support/v4/h/z;)V
...
.method final a(Landroid/support/v4/h/bb;)Landroid/support/v4/h/bb;
    .locals 3
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;

    invoke-static {v0, p1}, Landroid/support/design/widget/x;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-nez v0, :cond_0

    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/h/bb;)Landroid/support/v4/h/bb;
...
.method final a(I)V
    ...
    invoke-static {v2, v7}, Landroid/support/v4/h/f;->a(II)I
...
.method b(Landroid/view/View;I)V
    ...
    invoke-static {p1, v2}, Landroid/support/v4/h/ae;->d(Landroid/view/View;I)V
...
.method public c(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/d;->d(Ljava/lang/Object;)Ljava/util/List;
...
.method final getLastWindowInsets()Landroid/support/v4/h/bb;
    .locals 1
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->y:Landroid/support/v4/h/y;
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Landroid/support/v4/h/ae;->w(Landroid/view/View;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/bb;->b()I
...
.method protected onMeasure(II)V
    ...
    iget-object v1, v0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;

    if-eqz v1, :cond_1

    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/ae;->x(Landroid/view/View;)Z
    ...
    invoke-static {v2, v0}, Landroid/support/v4/h/f;->a(II)I
    ...
    invoke-static {v3}, Landroid/support/v4/h/ae;->x(Landroid/view/View;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/h/bb;->a()I

    move-result v1

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;
    ...
    iget-object v4, v0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/h/bb;

    invoke-virtual {v4}, Landroid/support/v4/h/bb;->d()I
    ...
    invoke-static {v3}, Landroid/support/v4/h/ae;->j(Landroid/view/View;)I

    move-result v1

    invoke-static {v11, v1}, Landroid/support/v4/h/ae;->a(II)I
    ...
    invoke-static {v13, v0, v1}, Landroid/support/v4/h/ae;->a(III)I
    ...
    invoke-static {v12, v0, v2}, Landroid/support/v4/h/ae;->a(III)I
