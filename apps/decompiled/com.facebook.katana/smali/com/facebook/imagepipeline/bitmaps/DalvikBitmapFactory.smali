...
.field private final d:Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;
...
.method public constructor <init>(Lcom/facebook/imagepipeline/bitmaps/EmptyJpegGenerator;Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;)V
    ...
    .line 48
    iput-object p1, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a:Lcom/facebook/imagepipeline/bitmaps/EmptyJpegGenerator;

    .line 49
    iput-object p2, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->d:Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;
    ...
    iput-object v0, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->b:Lcom/facebook/imagepipeline/memory/BitmapCounter;
    ...
    iput-object v0, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->c:Lcom/facebook/common/references/ResourceReleaser;

    .line 62
    return-void
.end method

.method private a(Lcom/facebook/common/references/CloseableReference;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 197
    iget-object v1, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->d:Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;

    add-int/lit8 v2, p2, 0x2

    invoke-virtual {v1, v2}, Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;->a(I)Lcom/facebook/common/references/CloseableReference;
    ...
    .line 201
    invoke-static {v1, p2}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->b([BI)Z
    ...
    .line 202
    invoke-static {v1, p2}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a([BI)V
...
.method private a(Lcom/facebook/common/references/CloseableReference;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private a(Landroid/graphics/Bitmap;)Lcom/facebook/common/references/CloseableReference;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 148
    iget-object v0, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->b:Lcom/facebook/imagepipeline/memory/BitmapCounter;
    ...
    .line 153
    :cond_0
    iget-object v0, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->c:Lcom/facebook/common/references/ResourceReleaser;
...
.method static synthetic a(Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;)Lcom/facebook/imagepipeline/memory/BitmapCounter;
    .locals 1
...
# virtual methods
.method final a(Lcom/facebook/imagepipeline/image/EncodedImage;)Lcom/facebook/common/references/CloseableReference;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a(I)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 105
    :try_start_0
    invoke-direct {p0, v1, v0}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a(Lcom/facebook/common/references/CloseableReference;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v0

    .line 106
    invoke-direct {p0, v0}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a(Landroid/graphics/Bitmap;)Lcom/facebook/common/references/CloseableReference;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final a(Lcom/facebook/imagepipeline/image/EncodedImage;I)Lcom/facebook/common/references/CloseableReference;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 129
    :try_start_0
    invoke-direct {p0, v1, p2, v0}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a(Lcom/facebook/common/references/CloseableReference;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method final a(SS)Lcom/facebook/common/references/CloseableReference;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(SS)",
    ...
    .prologue
    .line 74
    iget-object v0, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a:Lcom/facebook/imagepipeline/bitmaps/EmptyJpegGenerator;
    ...
    invoke-virtual {v2, v0}, Lcom/facebook/imagepipeline/image/EncodedImage;->a(Lcom/facebook/imageformat/ImageFormat;)V
    :try_end_0
    ...
    invoke-virtual {p0, v2, v0}, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->a(Lcom/facebook/imagepipeline/image/EncodedImage;I)Lcom/facebook/common/references/CloseableReference;
...
.method final a(Ljava/util/List;)Ljava/util/List;
    ...
    .line 262
    iget-object v2, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->b:Lcom/facebook/imagepipeline/memory/BitmapCounter;

    invoke-virtual {v2, v0}, Lcom/facebook/imagepipeline/memory/BitmapCounter;->a(Landroid/graphics/Bitmap;)Z
    ...
    .line 275
    iget-object v1, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->b:Lcom/facebook/imagepipeline/memory/BitmapCounter;

    invoke-virtual {v1, v0}, Lcom/facebook/imagepipeline/memory/BitmapCounter;->b(Landroid/graphics/Bitmap;)V
    ...
    .line 268
    iget-object v4, p0, Lcom/facebook/imagepipeline/bitmaps/DalvikBitmapFactory;->c:Lcom/facebook/common/references/ResourceReleaser;

    invoke-static {v0, v4}, Lcom/facebook/common/references/CloseableReference;->a(Ljava/lang/Object;Lcom/facebook/common/references/ResourceReleaser;)Lcom/facebook/common/references/CloseableReference;
    ...
    .line 280
    :cond_3
    invoke-static {v3}, Lcom/facebook/common/internal/Throwables;->b(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
