...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2, v3}, Lcom/facebook/soloader/DirectorySoSource;-><init>(Ljava/io/File;I)V
    ...
    iget-object v12, v0, Lcom/facebook/soloader/DirectorySoSource;->a:Ljava/io/File;

    .line 62
    invoke-static {v11}, Lcom/facebook/soloader/ApkSoSource;->a(Ljava/util/jar/JarFile;)Ljava/util/Map;

    move-result-object v5

    .line 63
    invoke-static/range {p1 .. p1}, Lcom/facebook/soloader/SysUtil;->a(Landroid/content/Context;)Lcom/facebook/soloader/FileLocker;
    :try_end_0
    ...
    check-cast v2, Lcom/facebook/soloader/ApkSoSource$SoInfo;

    .line 76
    if-eqz v2, :cond_0

    iget-object v3, v2, Lcom/facebook/soloader/ApkSoSource$SoInfo;->b:Ljava/util/jar/JarEntry;
    ...
    check-cast v0, Lcom/facebook/soloader/ApkSoSource$SoInfo;

    move-object v4, v0

    .line 99
    iget-object v6, v4, Lcom/facebook/soloader/ApkSoSource$SoInfo;->b:Ljava/util/jar/JarEntry;
    ...
    iget-object v4, v4, Lcom/facebook/soloader/ApkSoSource$SoInfo;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v2}, Lcom/facebook/androidcompat/AndroidCompat;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :try_start_d
    invoke-static {v3, v4}, Lcom/facebook/androidcompat/AndroidCompat;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method private static a(Ljava/util/jar/JarFile;)Ljava/util/Map;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Ljava/lang/String;",
            "Lcom/facebook/soloader/ApkSoSource$SoInfo;",
            ">;"
        }
    .end annotation
    ...
    check-cast v1, Lcom/facebook/soloader/ApkSoSource$SoInfo;

    .line 143
    if-eqz v1, :cond_1

    iget v1, v1, Lcom/facebook/soloader/ApkSoSource$SoInfo;->c:I

    if-ge v6, v1, :cond_0

    .line 144
    :cond_1
    new-instance v1, Lcom/facebook/soloader/ApkSoSource$SoInfo;

    invoke-direct {v1, v7, v0, v6}, Lcom/facebook/soloader/ApkSoSource$SoInfo;-><init>(Ljava/lang/String;Ljava/util/jar/JarEntry;I)V
