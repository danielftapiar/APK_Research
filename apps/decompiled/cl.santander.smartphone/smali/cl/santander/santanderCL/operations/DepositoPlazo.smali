.class public Lcl/santander/santanderCL/operations/DepositoPlazo;
.super Ljava/lang/Object;
.source "DepositoPlazo.java"
...
# instance fields
.field input:Lcl/santander/santanderCL/data/request/InputDepositoPlazo;

.field resp:Lcl/santander/santanderCL/response/DepositoPlazoResponse;
...
.method private getDepositoPlazo(Lcl/santander/santanderCL/request/DepositoPlazoRequest;)Lcl/santander/santanderCL/response/DepositoPlazoResponse;
    .locals 11
    .param p1, "req"    # Lcl/santander/santanderCL/request/DepositoPlazoRequest;
    ...
    .prologue
    .line 38
    const-string v0, "Mvld_HS_CAPBG525/DepositoPlazo"

    .line 41
    .local v0, "METHOD_NAME":Ljava/lang/String;
    new-instance v7, Lcl/santander/santanderCL/response/DepositoPlazoResponse;

    invoke-direct {v7}, Lcl/santander/santanderCL/response/DepositoPlazoResponse;-><init>()V

    .line 42
    .local v7, "resp":Lcl/santander/santanderCL/response/DepositoPlazoResponse;
    ...
    invoke-interface {v6}, Lcl/santander/santanderCL/operations/IOperations;->getDEPOSITOS_PLAZO()Ljava/lang/String;
    ...
    const-string v9, "DepositoPlazo_Request"
    ...
    invoke-virtual {v7, v8}, Lcl/santander/santanderCL/response/DepositoPlazoResponse;->parse(Lorg/ksoap2/serialization/SoapObject;)V
    :try_end_0
...
.method public execute()V
    ...
    .prologue
    .line 79
    new-instance v0, Lcl/santander/santanderCL/request/DepositoPlazoRequest;

    invoke-direct {v0}, Lcl/santander/santanderCL/request/DepositoPlazoRequest;-><init>()V

    .line 80
    .local v0, "req":Lcl/santander/santanderCL/request/DepositoPlazoRequest;
    iget-object v1, p0, Lcl/santander/santanderCL/operations/DepositoPlazo;->input:Lcl/santander/santanderCL/data/request/InputDepositoPlazo;

    invoke-virtual {v0, v1}, Lcl/santander/santanderCL/request/DepositoPlazoRequest;->setInput(Lcl/santander/santanderCL/data/request/InputDepositoPlazo;)V

    .line 81
    invoke-direct {p0, v0}, Lcl/santander/santanderCL/operations/DepositoPlazo;->getDepositoPlazo(Lcl/santander/santanderCL/request/DepositoPlazoRequest;)Lcl/santander/santanderCL/response/DepositoPlazoResponse;

    move-result-object v1

    iput-object v1, p0, Lcl/santander/santanderCL/operations/DepositoPlazo;->resp:Lcl/santander/santanderCL/response/DepositoPlazoResponse;

    .line 83
    iget-object v1, p0, Lcl/santander/santanderCL/operations/DepositoPlazo;->resp:Lcl/santander/santanderCL/response/DepositoPlazoResponse;

    invoke-virtual {v1}, Lcl/santander/santanderCL/response/DepositoPlazoResponse;->getInfo()Lcl/santander/santanderCL/data/response/Info;
    ...
    iget-object v2, p0, Lcl/santander/santanderCL/operations/DepositoPlazo;->resp:Lcl/santander/santanderCL/response/DepositoPlazoResponse;

    invoke-virtual {v2}, Lcl/santander/santanderCL/response/DepositoPlazoResponse;->getInfo()Lcl/santander/santanderCL/data/response/Info;
...
.method public getResult()Lcl/santander/santanderCL/response/DepositoPlazoResponse;
    .locals 1

    .prologue
    .line 90
    iget-object v0, p0, Lcl/santander/santanderCL/operations/DepositoPlazo;->resp:Lcl/santander/santanderCL/response/DepositoPlazoResponse;
...
.method public init(Ljava/lang/String;)V
    ...
    .line 33
    new-instance v1, Lcl/santander/santanderCL/data/request/InputDepositoPlazo;
    ...
    invoke-direct {v1, v2, v3}, Lcl/santander/santanderCL/data/request/InputDepositoPlazo;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v1, p0, Lcl/santander/santanderCL/operations/DepositoPlazo;->input:Lcl/santander/santanderCL/data/request/InputDepositoPlazo;
