...
.method private arrowScroll(I)Z
    ...
    invoke-direct {p0, v4, v3}, Landroid/support/v4/view/ViewPager;->getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
...
.method private onPageScrolled$486775f1(IF)V
    .locals 11
    ...
    :cond_1
    iget v0, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMin:I
    ...
    :cond_2
    iput p1, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMin:I

    :cond_3
    iget v0, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMax:I
    ...
    iget v1, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMax:I
    ...
    iput v0, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMax:I
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/view/ViewPager$OnPageChangeListener;->onPageScrolled$486775f1(IF)V
...
.method private pageScrolled(I)Z
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/view/ViewPager;->onPageScrolled$486775f1(IF)V
    ...
    invoke-direct {p0, v4, v1}, Landroid/support/v4/view/ViewPager;->onPageScrolled$486775f1(IF)V
...
.method private populate(I)V
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-direct {p0, v5, v0}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    :cond_f
    invoke-direct {p0, v5, v3}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    iget v2, v7, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F
    ...
    iget v1, v7, Landroid/support/v4/view/ViewPager$ItemInfo;->widthFactor:F
    ...
    invoke-direct {p0, v4}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ItemInfo;
...
.method private scrollToItem(IZIZ)V
    ...
    invoke-interface {v0}, Landroid/support/v4/view/ViewPager$OnPageChangeListener;->onPageSelected$13462e()V
    ...
    invoke-interface {v1}, Landroid/support/v4/view/ViewPager$OnPageChangeListener;->onPageSelected$13462e()V
...
.method private setScrollState(I)V
    ...
    iput v2, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMax:I

    iput v2, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMin:I

    :cond_2
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$PageTransformer;
    ...
    invoke-static {v5, v2}, Landroid/support/v4/view/ViewCompat;->setLayerType$7672597b(Landroid/view/View;I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_9
    invoke-direct {p0, v2, v3, v3, v4}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZI)V
    ...
    :cond_b
    iget v5, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMin:I
    ...
    :cond_c
    iget v5, p0, Landroid/support/v4/view/ViewPager;->mSeenPositionMax:I
    ...
    invoke-direct {p0, v0, v3, v1, v1}, Landroid/support/v4/view/ViewPager;->scrollToItem(IZIZ)V
...
.method final setOnAdapterChangeListener(Landroid/support/v4/view/ViewPager$OnAdapterChangeListener;)V
    .locals 0
