...
.method private static buildAndExecuteRequests(Lcom/facebook/AppEventsLogger$FlushReason;Ljava/util/Set;)Lcom/facebook/AppEventsLogger$FlushStatistics;
    ...
    check-cast v6, Lcom/facebook/Request;
...
.method private static handleResponse(Lcom/facebook/AppEventsLogger$AccessTokenAppIdPair;Lcom/facebook/Request;Lcom/facebook/Response;Lcom/facebook/AppEventsLogger$SessionEventsState;Lcom/facebook/AppEventsLogger$FlushStatistics;)V
    ...
    .line 850
    .local v2, "flushResult":Lcom/facebook/AppEventsLogger$FlushResult;
    if-eqz v0, :cond_0
    ...
    .line 853
    const-string v4, "Failed: No Connectivity"
    ...
    sget-object v6, Lcom/facebook/AppEventsLogger;->TAG:Ljava/lang/String;
    ...
    :goto_2
    invoke-virtual {p3, v5}, Lcom/facebook/AppEventsLogger$SessionEventsState;->clearInFlightAndStats(Z)V
    ...
    invoke-static {v5, p0, p3}, Lcom/facebook/AppEventsLogger$PersistedEvents;->persistEvents(Landroid/content/Context;Lcom/facebook/AppEventsLogger$AccessTokenAppIdPair;Lcom/facebook/AppEventsLogger$SessionEventsState;)V
    ...
    .line 893
    iget-object v5, p4, Lcom/facebook/AppEventsLogger$FlushStatistics;->result:Lcom/facebook/AppEventsLogger$FlushResult;

    sget-object v6, Lcom/facebook/AppEventsLogger$FlushResult;->NO_CONNECTIVITY:Lcom/facebook/AppEventsLogger$FlushResult;
    ...
    const-string v3, "<Can\'t encode events for debug logging>"
...
.method private static shouldSuppressEvent(Lcom/facebook/AppEventsLogger$AppEvent;)Z
    ...
    .line 650
    sget-object v3, Lcom/facebook/AppEventsLogger;->mapEventNameToSuppress:Ljava/util/Map;
    ...
    check-cast v1, Lcom/facebook/AppEventsLogger$EventSuppression;

    .line 651
    .local v1, "suppressionInfo":Lcom/facebook/AppEventsLogger$EventSuppression;
    if-nez v1, :cond_1
    ...
    .line 655
    :cond_1
    sget-object v3, Lcom/facebook/AppEventsLogger;->mapEventsToSuppressionTime:Ljava/util/Map;
    ...
    .line 661
    invoke-virtual {v1}, Lcom/facebook/AppEventsLogger$EventSuppression;->getTimeoutPeriod()I
    ...
    .line 667
    invoke-virtual {v1}, Lcom/facebook/AppEventsLogger$EventSuppression;->getBehavior()Lcom/facebook/AppEventsLogger$SuppressionTimeoutBehavior;

    move-result-object v3

    sget-object v4, Lcom/facebook/AppEventsLogger$SuppressionTimeoutBehavior;->RESET_TIMEOUT_WHEN_LOG_ATTEMPTED:Lcom/facebook/AppEventsLogger$SuppressionTimeoutBehavior;
