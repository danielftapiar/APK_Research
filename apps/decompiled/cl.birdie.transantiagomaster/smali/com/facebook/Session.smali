...
.method private getLoginActivityIntent(Lcom/facebook/Session$AuthorizationRequest;)Landroid/content/Intent;
    ...
    .line 1428
    invoke-static {v2}, Lcom/facebook/LoginActivity;->populateIntentExtras(Lcom/facebook/AuthorizationClient$AuthorizationRequest;)Landroid/os/Bundle;
...
.method static handlePermissionResponse(Lcom/facebook/Session;Lcom/facebook/Response;)Ljava/util/List;
    ...
    .line 653
    :cond_1
    const-class v9, Lcom/facebook/model/GraphMultiResult;

    invoke-virtual {p1, v9}, Lcom/facebook/Response;->getGraphObjectAs(Ljava/lang/Class;)Lcom/facebook/model/GraphObject;

    move-result-object v7

    check-cast v7, Lcom/facebook/model/GraphMultiResult;

    .line 654
    .local v7, "result":Lcom/facebook/model/GraphMultiResult;
    if-eqz v7, :cond_0

    .line 658
    invoke-interface {v7}, Lcom/facebook/model/GraphMultiResult;->getData()Lcom/facebook/model/GraphObjectList;
    ...
    invoke-interface {v5, v10}, Lcom/facebook/model/GraphObject;->getProperty(Ljava/lang/String;)Ljava/lang/Object;
...
.method private tryLoginActivity(Lcom/facebook/Session$AuthorizationRequest;)Z
    ...
    invoke-interface {v2, v0, v3}, Lcom/facebook/Session$StartActivityDelegate;->startActivityForResult(Landroid/content/Intent;I)V
    :try_end_0
...
.method public final getDeclinedPermissions()Ljava/util/List;
    ...
    .prologue
    .line 439
    iget-object v5, p0, Lcom/facebook/Session;->lock:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lcom/facebook/Session;->requestedPermissions:Ljava/util/Set;
