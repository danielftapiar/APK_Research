...
.method private downloadProfilePicture(Ljava/lang/String;Ljava/net/URI;Landroid/widget/ImageView;)V
    ...
    invoke-virtual {p2, v2}, Ljava/net/URI;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Lcom/facebook/widget/GraphObjectAdapter;->context:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v2, v3, p2}, Lcom/facebook/internal/ImageRequest$Builder;-><init>(Landroid/content/Context;Ljava/net/URI;)V
    ...
    .line 749
    new-instance v3, Lcom/facebook/widget/GraphObjectAdapter$2;

    invoke-direct {v3, p0, p1, p3}, Lcom/facebook/widget/GraphObjectAdapter$2;-><init>(Lcom/facebook/widget/GraphObjectAdapter;Ljava/lang/String;Landroid/widget/ImageView;)V
    ...
    .line 757
    .local v0, "newRequest":Lcom/facebook/internal/ImageRequest;
    ...
    .line 737
    .end local v0    # "newRequest":Lcom/facebook/internal/ImageRequest;
    .end local v1    # "prefetching":Z
    :cond_4
    const/4 v1, 0x0
...
.method private getActivityCircleView(Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    sget v2, Lcom/facebook/android/R$layout;->com_facebook_picker_activity_circle_row:I
    ...
    .line 313
    :cond_0
    sget v1, Lcom/facebook/android/R$id;->com_facebook_picker_row_activity_circle:I
...
.method private rebuildSections()V
    ...
    iput-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->sectionKeys:Ljava/util/List;
    ...
    iput-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->graphObjectsBySection:Ljava/util/Map;
    ...
    iput-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->graphObjectsById:Ljava/util/Map;

    .line 452
    iput-boolean v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->displaySections:Z

    .line 454
    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->cursor:Lcom/facebook/widget/GraphObjectCursor;

    if-eqz v4, :cond_0

    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->cursor:Lcom/facebook/widget/GraphObjectCursor;

    invoke-interface {v4}, Lcom/facebook/widget/GraphObjectCursor;->getCount()I
    ...
    invoke-interface {v4}, Lcom/facebook/widget/GraphObjectCursor;->moveToFirst()Z

    .line 461
    :cond_2
    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->cursor:Lcom/facebook/widget/GraphObjectCursor;

    invoke-interface {v4}, Lcom/facebook/widget/GraphObjectCursor;->getGraphObject()Lcom/facebook/model/GraphObject;
    ...
    .line 470
    .local v3, "sectionKeyOfItem":Ljava/lang/String;
    ...
    .line 477
    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->graphObjectsById:Ljava/util/Map;
    ...
    .line 478
    .end local v3    # "sectionKeyOfItem":Ljava/lang/String;
    :cond_4
    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->cursor:Lcom/facebook/widget/GraphObjectCursor;

    invoke-interface {v4}, Lcom/facebook/widget/GraphObjectCursor;->moveToNext()Z
    ...
    .line 480
    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->sortFields:Ljava/util/List;
    ...
    :goto_2
    iput-boolean v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->displaySections:Z
...
.method protected createGraphObjectView(Lcom/facebook/model/GraphObject;)Landroid/view/View;
    ...
    .line 328
    iget-object v4, p0, Lcom/facebook/widget/GraphObjectAdapter;->inflater:Landroid/view/LayoutInflater;
    ...
    sget v4, Lcom/facebook/android/R$id;->com_facebook_picker_checkbox_stub:I
    ...
    .line 333
    invoke-virtual {v1, v8}, Landroid/view/ViewStub;->setVisibility(I)V

    .line 340
    :cond_0
    :goto_0
    sget v4, Lcom/facebook/android/R$id;->com_facebook_picker_profile_pic_stub:I
    ...
    .line 341
    .local v2, "profilePicStub":Landroid/view/ViewStub;
    ...
    .line 335
    .end local v2    # "profilePicStub":Landroid/view/ViewStub;
    :cond_1
    ...
    invoke-virtual {p0, v0, v7}, Lcom/facebook/widget/GraphObjectAdapter;->updateCheckboxState(Landroid/widget/CheckBox;Z)V

    goto :goto_0

    .line 344
    .end local v0    # "checkBox":Landroid/widget/CheckBox;
    .restart local v2    # "profilePicStub":Landroid/view/ViewStub;
    :cond_2
...
.method getPictureFieldSpecifier()Ljava/lang/String;
    ...
    .line 430
    invoke-virtual {p0, v2}, Lcom/facebook/widget/GraphObjectAdapter;->createGraphObjectView(Lcom/facebook/model/GraphObject;)Landroid/view/View;
...
.method protected getPictureUriOfGraphObject(Lcom/facebook/model/GraphObject;)Ljava/net/URI;
    ...
    const-class v4, Lcom/facebook/widget/GraphObjectAdapter$ItemPicture;

    invoke-interface {v3, v4}, Lcom/facebook/model/GraphObject;->cast(Ljava/lang/Class;)Lcom/facebook/model/GraphObject;

    move-result-object v3

    check-cast v3, Lcom/facebook/widget/GraphObjectAdapter$ItemPicture;

    .line 269
    invoke-interface {v3}, Lcom/facebook/widget/GraphObjectAdapter$ItemPicture;->getData()Lcom/facebook/widget/GraphObjectAdapter$ItemPictureData;
