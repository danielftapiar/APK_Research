...
.method private appendParametersToBaseUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, p1}, Landroid/net/Uri$Builder;->encodedPath(Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    :cond_3
    iget-object v4, p0, Lcom/facebook/Request;->httpMethod:Lcom/facebook/HttpMethod;
    ...
    const-string v4, "Unsupported parameter type for GET request: %s"
...
.method public static executeConnectionAndWait(Ljava/net/HttpURLConnection;Lcom/facebook/RequestBatch;)Ljava/util/List;
    ...
    .line 1635
    .local v3, "sessions":Ljava/util/HashSet;, "Ljava/util/HashSet<Lcom/facebook/Session;>;"
    ...
    iget-object v5, v1, Lcom/facebook/Request;->session:Lcom/facebook/Session;
...
.method private static getBatchAppId(Lcom/facebook/RequestBatch;)Ljava/lang/String;
    ...
    .line 2196
    sget-object v1, Lcom/facebook/Request;->defaultBatchApplicationId:Ljava/lang/String;
    ...
    .line 2191
    iget-object v0, v1, Lcom/facebook/Request;->session:Lcom/facebook/Session;
...
.method private static processGraphObject(Lcom/facebook/model/GraphObject;Ljava/lang/String;Lcom/facebook/Request$KeyValueSerializer;)V
    ...
    .restart local v4    # "questionMarkLocation":I
    :cond_3
    move v2, v7
    ...
    invoke-static {v5, v9, p2, v3}, Lcom/facebook/Request;->processGraphObjectProperty(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/Request$KeyValueSerializer;Z)V

    goto :goto_1

    .end local v3    # "passByValue":Z
    :cond_5
    move v3, v7
...
.method private static processGraphObjectProperty(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/Request$KeyValueSerializer;Z)V
    ...
    .line 2091
    :cond_1
    const-class v11, Lcom/facebook/model/GraphObjectList;
    ...
    invoke-static {v11, v12, v0, v1}, Lcom/facebook/Request;->processGraphObjectProperty(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/Request$KeyValueSerializer;Z)V
    ...
    .end local v4    # "iso8601DateFormat":Ljava/text/SimpleDateFormat;
    :cond_9
    move-object/from16 v6, p1
...
.method private static serializeAttachments(Ljava/util/Map;Lcom/facebook/Request$Serializer;)V
    ...
    invoke-virtual {p1, v1, v3, v4}, Lcom/facebook/Request$Serializer;->writeObject(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/Request;)V
...
.method private static serializeParameters(Landroid/os/Bundle;Lcom/facebook/Request$Serializer;Lcom/facebook/Request;)V
    ...
    .line 2145
    invoke-virtual {p1, v0, v1, p2}, Lcom/facebook/Request$Serializer;->writeObject(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/Request;)V
...
.method private static serializeRequestsAsJSON(Lcom/facebook/Request$Serializer;Ljava/util/Collection;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v1, v0, p1}, Lcom/facebook/Request$Serializer;->writeRequestsAsJson(Ljava/lang/String;Lorg/json/JSONArray;Ljava/util/Collection;)V
...
.method private serializeToBatch(Lorg/json/JSONArray;Ljava/util/Map;)V
    ...
    iget-object v10, p0, Lcom/facebook/Request;->batchEntryName:Ljava/lang/String;
    ...
    iget-object v11, p0, Lcom/facebook/Request;->batchEntryName:Ljava/lang/String;

    invoke-virtual {v3, v10, v11}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    .line 1887
    const-string v10, "omit_response_on_success"

    iget-boolean v11, p0, Lcom/facebook/Request;->batchEntryOmitResultOnSuccess:Z

    invoke-virtual {v3, v10, v11}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    .line 1889
    :cond_0
    iget-object v10, p0, Lcom/facebook/Request;->batchEntryDependsOn:Ljava/lang/String;
    ...
    iget-object v11, p0, Lcom/facebook/Request;->batchEntryDependsOn:Ljava/lang/String;
    ...
    iget-object v11, p0, Lcom/facebook/Request;->httpMethod:Lcom/facebook/HttpMethod;

    invoke-virtual {v3, v10, v11}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    .line 1896
    iget-object v10, p0, Lcom/facebook/Request;->session:Lcom/facebook/Session;
    ...
    invoke-virtual {v10}, Lcom/facebook/Session;->getAccessToken()Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/facebook/Request;->parameters:Landroid/os/Bundle;
    ...
    :cond_4
    iget-object v10, p0, Lcom/facebook/Request;->graphObject:Lcom/facebook/model/GraphObject;
    ...
    .line 1922
    .local v6, "keysAndValues":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    iget-object v10, p0, Lcom/facebook/Request;->graphObject:Lcom/facebook/model/GraphObject;

    new-instance v11, Lcom/facebook/Request$5;

    invoke-direct {v11, p0, v6}, Lcom/facebook/Request$5;-><init>(Lcom/facebook/Request;Ljava/util/ArrayList;)V

    invoke-static {v10, v8, v11}, Lcom/facebook/Request;->processGraphObject(Lcom/facebook/model/GraphObject;Ljava/lang/String;Lcom/facebook/Request$KeyValueSerializer;)V
    ...
    .end local v6    # "keysAndValues":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_5
    ...
    iget-object v11, p0, Lcom/facebook/Request;->parameters:Landroid/os/Bundle;
    ...
    invoke-static {v9}, Lcom/facebook/Request;->isSupportedAttachmentType(Ljava/lang/Object;)Z
    ...
    .line 1910
    new-instance v11, Lcom/facebook/Request$Attachment;

    invoke-direct {v11, p0, v9}, Lcom/facebook/Request$Attachment;-><init>(Lcom/facebook/Request;Ljava/lang/Object;)V
...
.method static final serializeToUrlConnection(Lcom/facebook/RequestBatch;Ljava/net/HttpURLConnection;)V
    ...
    .line 1959
    new-instance v8, Lcom/facebook/internal/Logger;

    sget-object v5, Lcom/facebook/LoggingBehavior;->REQUESTS:Lcom/facebook/LoggingBehavior;

    const-string v13, "Request"

    invoke-direct {v8, v5, v13}, Lcom/facebook/internal/Logger;-><init>(Lcom/facebook/LoggingBehavior;Ljava/lang/String;)V

    .line 1961
    .local v8, "logger":Lcom/facebook/internal/Logger;
    invoke-virtual {p0}, Lcom/facebook/RequestBatch;->size()I
    ...
    iget-object v6, v5, Lcom/facebook/Request;->httpMethod:Lcom/facebook/HttpMethod;
    ...
    invoke-virtual {v8, v5}, Lcom/facebook/internal/Logger;->append(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v5, v13}, Lcom/facebook/internal/Logger;->appendKeyValue(Ljava/lang/String;Ljava/lang/Object;)V

    .line 1969
    const-string v5, "URL"

    invoke-virtual {v8, v5, v12}, Lcom/facebook/internal/Logger;->appendKeyValue(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v13}, Ljava/net/HttpURLConnection;->getRequestProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1981
    invoke-virtual {v8}, Lcom/facebook/internal/Logger;->log()V
    ...
    invoke-static {p0, v2, v10, v12, v7}, Lcom/facebook/Request;->processRequest(Lcom/facebook/RequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;)V
    ...
    :goto_2
    :try_start_1
    invoke-static {p0, v8, v10, v12, v0}, Lcom/facebook/Request;->processRequest(Lcom/facebook/RequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;)V
    :try_end_1
...
.method public static toHttpConnection(Lcom/facebook/RequestBatch;)Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v4}, Lcom/facebook/Request;->validate()V
