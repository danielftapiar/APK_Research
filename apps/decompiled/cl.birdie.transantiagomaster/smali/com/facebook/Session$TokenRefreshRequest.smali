...
.method private refreshToken()V
    ...
    invoke-virtual {v3}, Lcom/facebook/Session;->getTokenInfo()Lcom/facebook/AccessToken;
    ...
    .line 1696
    iget-object v2, p0, Lcom/facebook/Session$TokenRefreshRequest;->messageReceiver:Landroid/os/Messenger;

    iput-object v2, v0, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    .line 1699
    :try_start_0
    iget-object v2, p0, Lcom/facebook/Session$TokenRefreshRequest;->messageSender:Landroid/os/Messenger;
