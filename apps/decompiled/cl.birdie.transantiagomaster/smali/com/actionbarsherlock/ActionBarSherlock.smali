...
.method public static wrap(Landroid/app/Activity;I)Lcom/actionbarsherlock/ActionBarSherlock;
    ...
    sget-object v10, Lcom/actionbarsherlock/ActionBarSherlock;->IMPLEMENTATIONS:Ljava/util/HashMap;

    invoke-direct {v4, v10}, Ljava/util/HashMap;-><init>(Ljava/util/Map;)V

    .line 175
    .local v4, "impls":Ljava/util/HashMap;, "Ljava/util/HashMap<Lcom/actionbarsherlock/ActionBarSherlock$Implementation;Ljava/lang/Class<+Lcom/actionbarsherlock/ActionBarSherlock;>;>;"
    const/4 v2, 0x0

    .line 176
    .local v2, "hasQualfier":Z
    ...
    .local v8, "keys":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/actionbarsherlock/ActionBarSherlock$Implementation;>;"
    :cond_2
    :goto_1
    ...
    .line 195
    .end local v5    # "isTvDpi":Z
    .end local v8    # "keys":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/actionbarsherlock/ActionBarSherlock$Implementation;>;"
    :cond_3
    const/4 v2, 0x0
    ...
    .restart local v8    # "keys":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/actionbarsherlock/ActionBarSherlock$Implementation;>;"
    :cond_5
    :goto_3
    invoke-interface {v8}, Ljava/util/Iterator;->hasNext()Z
    ...
    const-string v11, "More than one implementation matches configuration."
    ...
    check-cast v10, Lcom/actionbarsherlock/ActionBarSherlock$Implementation;

    .line 178
    invoke-interface {v10}, Lcom/actionbarsherlock/ActionBarSherlock$Implementation;->dpi()I
    ...
    .line 197
    invoke-interface {v10}, Lcom/actionbarsherlock/ActionBarSherlock$Implementation;->api()I
    ...
    const-string v11, "No implementations match configuration."
    ...
    .line 230
    .local v3, "impl":Ljava/lang/Class;, "Ljava/lang/Class<+Lcom/actionbarsherlock/ActionBarSherlock;>;"
    :try_start_0
    sget-object v10, Lcom/actionbarsherlock/ActionBarSherlock;->CONSTRUCTOR_ARGS:[Ljava/lang/Class;
    ...
    check-cast v10, Lcom/actionbarsherlock/ActionBarSherlock;
    :try_end_0
...
.method protected final callbackCreateOptionsMenu(Lcom/actionbarsherlock/view/Menu;)Z
    ...
    check-cast v1, Lcom/actionbarsherlock/ActionBarSherlock$OnCreatePanelMenuListener;

    .line 560
    const/4 v2, 0x0

    invoke-interface {v1, v2, p1}, Lcom/actionbarsherlock/ActionBarSherlock$OnCreatePanelMenuListener;->onCreatePanelMenu(ILcom/actionbarsherlock/view/Menu;)Z
    ...
    check-cast v1, Lcom/actionbarsherlock/ActionBarSherlock$OnCreateOptionsMenuListener;

    .line 563
    invoke-interface {v1, p1}, Lcom/actionbarsherlock/ActionBarSherlock$OnCreateOptionsMenuListener;->onCreateOptionsMenu(Lcom/actionbarsherlock/view/Menu;)Z
...
.method protected final callbackOptionsItemSelected(Lcom/actionbarsherlock/view/MenuItem;)Z
    ...
    instance-of v1, v1, Lcom/actionbarsherlock/ActionBarSherlock$OnMenuItemSelectedListener;
    ...
    check-cast v1, Lcom/actionbarsherlock/ActionBarSherlock$OnMenuItemSelectedListener;

    .line 604
    const/4 v2, 0x0

    invoke-interface {v1, v2, p1}, Lcom/actionbarsherlock/ActionBarSherlock$OnMenuItemSelectedListener;->onMenuItemSelected(ILcom/actionbarsherlock/view/MenuItem;)Z
    ...
    check-cast v1, Lcom/actionbarsherlock/ActionBarSherlock$OnOptionsItemSelectedListener;

    .line 607
    invoke-interface {v1, p1}, Lcom/actionbarsherlock/ActionBarSherlock$OnOptionsItemSelectedListener;->onOptionsItemSelected(Lcom/actionbarsherlock/view/MenuItem;)Z
...
.method protected final callbackPrepareOptionsMenu(Lcom/actionbarsherlock/view/Menu;)Z
    ...
    check-cast v1, Lcom/actionbarsherlock/ActionBarSherlock$OnPreparePanelListener;
    ...
    invoke-interface {v1, v2, v3, p1}, Lcom/actionbarsherlock/ActionBarSherlock$OnPreparePanelListener;->onPreparePanel(ILandroid/view/View;Lcom/actionbarsherlock/view/Menu;)Z
    ...
    check-cast v1, Lcom/actionbarsherlock/ActionBarSherlock$OnPrepareOptionsMenuListener;

    .line 584
    invoke-interface {v1, p1}, Lcom/actionbarsherlock/ActionBarSherlock$OnPrepareOptionsMenuListener;->onPrepareOptionsMenu(Lcom/actionbarsherlock/view/Menu;)Z
