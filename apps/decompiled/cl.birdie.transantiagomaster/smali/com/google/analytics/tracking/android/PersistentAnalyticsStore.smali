.class final Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;
...
.method private constructor <init>(Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;Landroid/content/Context;Ljava/lang/String;)V
    .locals 3
    .param p1, "listener"    # Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;
    .param p2, "ctx"    # Landroid/content/Context;
...
.method private deleteHits(Ljava/util/Collection;)V
    .locals 7
    ...
    :cond_2
    invoke-direct {p0, v1}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->deleteHits([Ljava/lang/String;)V

    goto :goto_0
.end method

.method private deleteHits([Ljava/lang/String;)V
    .locals 9
    ...
    .line 465
    :cond_0
    const-string v2, "Empty hitIds passed to deleteHits."
    ...
    .line 468
    :cond_2
    const-string v4, "Error opening database for deleteHits."
    ...
    invoke-direct {p0}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->getNumStoredHits()I
...
.method private static fillVersionParameter(Ljava/util/Map;Ljava/util/Collection;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 188
    .local p0, "wireFormatParams":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    .local p1, "commands":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/google/android/gms/analytics/internal/Command;>;"
    const-string v3, "&_v"
...
.method private static generateHitString(Ljava/util/Map;)Ljava/lang/String;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getNumStoredHits()I
    .locals 5
    ...
    .line 484
    .local v2, "numStoredHits":I
    const-string v4, "Error opening database for getNumStoredHits."
...
.method private peekHitIds(I)Ljava/util/List;
    .locals 14
    .param p1, "maxHits"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private peekHits$22f3aa59()Ljava/util/List;
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 316
    .local v15, "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    ...
    .line 339
    .end local v15    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    .local v16, "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :try_start_1
    ...
    .line 341
    :cond_1
    new-instance v14, Lcom/google/analytics/tracking/android/Hit;
    ...
    invoke-direct {v14, v2, v3, v4, v5}, Lcom/google/analytics/tracking/android/Hit;-><init>(JJ)V

    .line 342
    .local v14, "hit":Lcom/google/analytics/tracking/android/Hit;
    ...
    .line 349
    .end local v14    # "hit":Lcom/google/analytics/tracking/android/Hit;
    :cond_2
    if-eqz v11, :cond_3
    ...
    .end local v16    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    .restart local v15    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    goto/16 :goto_0
    ...
    .restart local v16    # "hits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :cond_9
    :try_start_4
    ...
    .line 393
    .local v18, "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    const/4 v13, 0x0

    .line 394
    .local v13, "foundOneBadHit":Z
    ...
    check-cast v14, Lcom/google/analytics/tracking/android/Hit;

    .line 395
    .restart local v14    # "hit":Lcom/google/analytics/tracking/android/Hit;
    invoke-virtual {v14}, Lcom/google/analytics/tracking/android/Hit;->getHitParams()Ljava/lang/String;
    ...
    .line 406
    .end local v12    # "e":Landroid/database/sqlite/SQLiteException;
    .end local v13    # "foundOneBadHit":Z
    .end local v14    # "hit":Lcom/google/analytics/tracking/android/Hit;
    .end local v17    # "i$":Ljava/util/Iterator;
    .end local v18    # "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :catchall_1
    move-exception v2
    ...
    .line 406
    .restart local v12    # "e":Landroid/database/sqlite/SQLiteException;
    .restart local v13    # "foundOneBadHit":Z
    .restart local v17    # "i$":Ljava/util/Iterator;
    .restart local v18    # "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :cond_c
    if-eqz v11, :cond_d
...
# virtual methods
.method public final clearHits$1349ef()V
    .locals 8
    ...
    invoke-virtual {v0, v4, v7, v7}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public final dispatch()V
    ...
    .line 513
    :cond_1
    invoke-direct {p0}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->peekHits$22f3aa59()Ljava/util/List;
    ...
    invoke-direct {p0, v2}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->deleteHits(Ljava/util/Collection;)V
...
.method public final getDispatcher()Lcom/google/analytics/tracking/android/Dispatcher;
    .locals 1
...
.method public final putHit(Ljava/util/Map;JLjava/lang/String;Ljava/util/Collection;)V
    .locals 8
    ...
    invoke-direct {p0, v0}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->peekHitIds(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->deleteHits([Ljava/lang/String;)V

    .line 180
    :cond_1
    invoke-static {p1, p5}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->fillVersionParameter(Ljava/util/Map;Ljava/util/Collection;)V
