...
.method constructor <init>(Landroid/content/Context;Lcom/google/analytics/tracking/android/AnalyticsThread;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/google/analytics/tracking/android/GAServiceProxy;-><init>(Landroid/content/Context;Lcom/google/analytics/tracking/android/AnalyticsThread;Lcom/google/analytics/tracking/android/GoogleAnalytics;)V

    .line 91
    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lcom/google/analytics/tracking/android/AnalyticsThread;Lcom/google/analytics/tracking/android/GoogleAnalytics;)V
    .locals 2
    .param p1, "ctx"    # Landroid/content/Context;
    .param p2, "thread"    # Lcom/google/analytics/tracking/android/AnalyticsThread;
    .param p3, "gaInstance"    # Lcom/google/analytics/tracking/android/GoogleAnalytics;
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAServiceProxy;->testStore:Lcom/google/analytics/tracking/android/AnalyticsStore;
    ...
    .line 78
    iput-object p3, p0, Lcom/google/analytics/tracking/android/GAServiceProxy;->gaInstance:Lcom/google/analytics/tracking/android/GoogleAnalytics;
...
.method private static cancelTimer(Ljava/util/Timer;)Ljava/util/Timer;
    .locals 1
...
.method private clearAllTimers()V
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/GAServiceProxy;->cancelTimer(Ljava/util/Timer;)Ljava/util/Timer;
...
.method private declared-synchronized connectToService()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/google/analytics/tracking/android/GAServiceProxy$FailedConnectTask;-><init>(Lcom/google/analytics/tracking/android/GAServiceProxy;B)V
...
.method private fireReconnectAttempt()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/google/analytics/tracking/android/GAServiceProxy$ReconnectTask;-><init>(Lcom/google/analytics/tracking/android/GAServiceProxy;B)V
...
.method private declared-synchronized sendQueue()V
    ...
    invoke-interface {v0}, Lcom/google/analytics/tracking/android/AnalyticsStore;->clearHits$1349ef()V
...
.method public final declared-synchronized onConnected()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/google/analytics/tracking/android/GAServiceProxy$DisconnectCheckTask;-><init>(Lcom/google/analytics/tracking/android/GAServiceProxy;B)V
...
.method public final declared-synchronized onConnectionFailed$10b55c15(I)V
    .locals 2
...
.method public final putHit(Ljava/util/Map;JLjava/lang/String;Ljava/util/List;)V
    .locals 7
...
.method public final declared-synchronized setForceLocalDispatch()V
    .locals 2
