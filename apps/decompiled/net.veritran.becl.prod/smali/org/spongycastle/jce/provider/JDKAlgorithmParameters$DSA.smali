.class public Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;
...
.method protected engineGetEncoded()[B
    ...
    iget-object v2, p0, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->currentSpec:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v2}, Ljava/security/spec/DSAParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->currentSpec:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v3}, Ljava/security/spec/DSAParameterSpec;->getQ()Ljava/math/BigInteger;

    move-result-object v3

    iget-object v4, p0, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->currentSpec:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineGetEncoded(Ljava/lang/String;)[B
    ...
    .prologue
    .line 655
    invoke-virtual {p0, p1}, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->isASN1FormatString(Ljava/lang/String;)Z
    ...
    .line 657
    invoke-virtual {p0}, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->engineGetEncoded()[B
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->currentSpec:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineInit([B)V
    ...
    invoke-direct {v0, v2}, Lorg/spongycastle/asn1/x509/DSAParameter;-><init>(Lorg/spongycastle/asn1/ASN1Sequence;)V
    ...
    iput-object v2, p0, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->currentSpec:Ljava/security/spec/DSAParameterSpec;
    :try_end_0
...
.method protected engineInit([BLjava/lang/String;)V
    ...
    .prologue
    .line 712
    invoke-virtual {p0, p2}, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->isASN1FormatString(Ljava/lang/String;)Z
    ...
    .line 714
    :cond_0
    invoke-virtual {p0, p1}, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->engineInit([B)V
...
.method protected localEngineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    .line 669
    iget-object v0, p0, Lorg/spongycastle/jce/provider/JDKAlgorithmParameters$DSA;->currentSpec:Ljava/security/spec/DSAParameterSpec;
