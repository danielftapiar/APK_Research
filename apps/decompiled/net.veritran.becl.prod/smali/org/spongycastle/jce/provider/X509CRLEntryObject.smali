...
.method public constructor <init>(Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;)V
    ...
    .line 48
    invoke-direct {p0}, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->loadCertificateIssuer()Ljavax/security/auth/x500/X500Principal;

    move-result-object v0

    iput-object v0, p0, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->certificateIssuer:Ljavax/security/auth/x500/X500Principal;

    .line 49
    return-void
.end method

.method public constructor <init>(Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;ZLjavax/security/auth/x500/X500Principal;)V
    .locals 1
    .param p1, "c"    # Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;
    .param p2, "isIndirect"    # Z
    .param p3, "previousCertificateIssuer"    # Ljavax/security/auth/x500/X500Principal;
    ...
    .line 74
    iput-boolean p2, p0, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->isIndirect:Z

    .line 75
    iput-object p3, p0, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->previousCertificateIssuer:Ljavax/security/auth/x500/X500Principal;
...
.method private getExtensionOIDs(Z)Ljava/util/Set;
    ...
    invoke-virtual {v5}, Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;->getExtensions()Lorg/spongycastle/asn1/x509/X509Extensions;
...
.method private loadCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    .line 92
    iget-boolean v5, p0, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->isIndirect:Z
    ...
    .line 97
    :cond_1
    sget-object v5, Lorg/spongycastle/asn1/x509/X509Extensions;->CertificateIssuer:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v5}, Lorg/spongycastle/asn1/ASN1ObjectIdentifier;->getId()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {p0, v5}, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->getExtensionValue(Ljava/lang/String;)[B
    ...
    .line 100
    iget-object v4, p0, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->previousCertificateIssuer:Ljavax/security/auth/x500/X500Principal;
    ...
    invoke-virtual {v6}, Lorg/spongycastle/asn1/x509/GeneralName;->getName()Lorg/spongycastle/asn1/DEREncodable;
    ...
    invoke-virtual {v6}, Lorg/spongycastle/asn1/DERObject;->getDEREncoded()[B
...
.method public getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    .prologue
    .line 124
    iget-object v0, p0, Lorg/spongycastle/jce/provider/X509CRLEntryObject;->certificateIssuer:Ljavax/security/auth/x500/X500Principal;
...
.method public getExtensionValue(Ljava/lang/String;)[B
    ...
    invoke-virtual {v3}, Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;->getExtensions()Lorg/spongycastle/asn1/x509/X509Extensions;
...
.method public getSerialNumber()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;->getUserCertificate()Lorg/spongycastle/asn1/DERInteger;
...
.method public hasExtensions()Z
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;->getExtensions()Lorg/spongycastle/asn1/x509/X509Extensions;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lorg/spongycastle/asn1/x509/TBSCertList$CRLEntry;->getExtensions()Lorg/spongycastle/asn1/x509/X509Extensions;
    ...
    check-cast v8, Lorg/spongycastle/asn1/DERObjectIdentifier;

    .line 251
    .local v8, "oid":Lorg/spongycastle/asn1/DERObjectIdentifier;
    invoke-virtual {v5, v8}, Lorg/spongycastle/asn1/x509/X509Extensions;->getExtension(Lorg/spongycastle/asn1/DERObjectIdentifier;)Lorg/spongycastle/asn1/x509/X509Extension;
    ...
    .line 259
    :try_start_0
    sget-object v9, Lorg/spongycastle/asn1/x509/X509Extensions;->ReasonCode:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v8, v9}, Lorg/spongycastle/asn1/DERObjectIdentifier;->equals(Ljava/lang/Object;)Z
    ...
    .line 261
    new-instance v9, Lorg/spongycastle/asn1/x509/CRLReason;

    invoke-virtual {v1}, Lorg/spongycastle/asn1/ASN1InputStream;->readObject()Lorg/spongycastle/asn1/DERObject;

    move-result-object v10

    invoke-static {v10}, Lorg/spongycastle/asn1/DEREnumerated;->getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/DEREnumerated;

    move-result-object v10

    invoke-direct {v9, v10}, Lorg/spongycastle/asn1/x509/CRLReason;-><init>(Lorg/spongycastle/asn1/DEREnumerated;)V
    ...
    invoke-virtual {v8}, Lorg/spongycastle/asn1/DERObjectIdentifier;->getId()Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    sget-object v9, Lorg/spongycastle/asn1/x509/X509Extensions;->CertificateIssuer:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
    ...
    new-instance v11, Lorg/spongycastle/asn1/x509/GeneralNames;
    ...
    invoke-direct {v11, v9}, Lorg/spongycastle/asn1/x509/GeneralNames;-><init>(Lorg/spongycastle/asn1/ASN1Sequence;)V
    ...
    .end local v8    # "oid":Lorg/spongycastle/asn1/DERObjectIdentifier;
    :cond_3
