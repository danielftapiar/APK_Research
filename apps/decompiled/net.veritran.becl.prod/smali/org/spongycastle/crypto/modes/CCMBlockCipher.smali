...
.method public constructor <init>(Lorg/spongycastle/crypto/BlockCipher;)V
    ...
    iput-object v0, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->data:Ljava/io/ByteArrayOutputStream;
...
.method private calculateMac([BII[B)I
    ...
    iget-object v6, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->cipher:Lorg/spongycastle/crypto/BlockCipher;

    iget v7, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macSize:I

    mul-int/lit8 v7, v7, 0x8

    invoke-direct {v1, v6, v7}, Lorg/spongycastle/crypto/macs/CBCBlockCipherMac;-><init>(Lorg/spongycastle/crypto/BlockCipher;I)V

    .line 259
    .local v1, "cMac":Lorg/spongycastle/crypto/Mac;
    iget-object v6, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->keyParam:Lorg/spongycastle/crypto/CipherParameters;

    invoke-interface {v1, v6}, Lorg/spongycastle/crypto/Mac;->init(Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    .line 275
    iget-object v6, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->nonce:[B

    const/4 v7, 0x1

    iget-object v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->nonce:[B
    ...
    invoke-interface {v1, v0, v9, v6}, Lorg/spongycastle/crypto/Mac;->update([BII)V
    ...
    .line 295
    iget-object v6, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->associatedText:[B
    ...
    invoke-interface {v1, v6}, Lorg/spongycastle/crypto/Mac;->update(B)V
    ...
    iget-object v7, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->associatedText:[B

    array-length v7, v7

    invoke-interface {v1, v6, v9, v7}, Lorg/spongycastle/crypto/Mac;->update([BII)V
    ...
    .line 321
    invoke-interface {v1, v9}, Lorg/spongycastle/crypto/Mac;->update(B)V
    ...
    .line 331
    invoke-interface {v1, p4, v9}, Lorg/spongycastle/crypto/Mac;->doFinal([BI)I
...
.method private hasAssociatedText()Z
    ...
    .prologue
    .line 336
    iget-object v0, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->associatedText:[B
...
.method public doFinal([BI)I
    ...
    .line 115
    iget-object v2, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->data:Ljava/io/ByteArrayOutputStream;
    ...
    invoke-virtual {p0, v1, v3, v2}, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->processPacket([BII)[B
...
.method public getOutputSize(I)I
    ...
    .line 155
    iget-object v0, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->data:Ljava/io/ByteArrayOutputStream;
...
.method public init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    .line 71
    .local v0, "param":Lorg/spongycastle/crypto/params/AEADParameters;
    ...
    iput-object v1, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->associatedText:[B
    ...
    iput-object v1, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->keyParam:Lorg/spongycastle/crypto/CipherParameters;

    .line 89
    .end local v0    # "param":Lorg/spongycastle/crypto/params/AEADParameters;
    :goto_0
    return-void
    ...
    .line 80
    .local v0, "param":Lorg/spongycastle/crypto/params/ParametersWithIV;
    ...
    .line 87
    .end local v0    # "param":Lorg/spongycastle/crypto/params/ParametersWithIV;
    :cond_1
...
.method public processPacket([BII)[B
    ...
    .line 166
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->keyParam:Lorg/spongycastle/crypto/CipherParameters;
    ...
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->cipher:Lorg/spongycastle/crypto/BlockCipher;

    invoke-direct {v2, v8}, Lorg/spongycastle/crypto/modes/SICBlockCipher;-><init>(Lorg/spongycastle/crypto/BlockCipher;)V

    .line 172
    .local v2, "ctrCipher":Lorg/spongycastle/crypto/BlockCipher;
    iget v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->blockSize:I
    ...
    .line 179
    iget-boolean v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->forEncryption:Z

    new-instance v9, Lorg/spongycastle/crypto/params/ParametersWithIV;

    iget-object v10, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->keyParam:Lorg/spongycastle/crypto/CipherParameters;

    invoke-direct {v9, v10, v5}, Lorg/spongycastle/crypto/params/ParametersWithIV;-><init>(Lorg/spongycastle/crypto/CipherParameters;[B)V

    invoke-interface {v2, v8, v9}, Lorg/spongycastle/crypto/BlockCipher;->init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    .line 188
    .local v6, "out":[B
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    invoke-direct {p0, p1, p2, p3, v8}, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->calculateMac([BII[B)I

    .line 190
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    iget-object v9, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    invoke-interface {v2, v8, v11, v9, v11}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 194
    invoke-interface {v2, p1, v4, v6, v7}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 203
    invoke-interface {v2, v0, v11, v0, v11}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    iget v9, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macSize:I

    sub-int/2addr v8, v9

    iget-object v9, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    iget v10, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macSize:I
    ...
    iget v9, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->blockSize:I
    ...
    invoke-direct {p0, v6, v11, v8, v1}, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->calculateMac([BII[B)I

    .line 246
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/CCMBlockCipher;->macBlock:[B

    invoke-static {v8, v1}, Lorg/spongycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
