...
.method private F(IIJ)J
    ...
    .line 330
    .local v1, "r1":I
    invoke-direct {p0, v0, p1, v1, p2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->phaseCalc2(IIII)I

    move-result v3

    .line 331
    .local v3, "rd1":I
    invoke-direct {p0, v0, p1, v1, p2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->phaseCalc1(IIII)I
...
.method private createWorkingKey([B)[I
    ...
    invoke-direct {p0, p1, v10}, Lorg/spongycastle/crypto/engines/SEEDEngine;->bytesToLong([BI)J
    ...
    .line 249
    .local v8, "upper":J
    invoke-direct {p0, v6, v7}, Lorg/spongycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v2

    .line 250
    .local v2, "key0":I
    invoke-direct {p0, v6, v7}, Lorg/spongycastle/crypto/engines/SEEDEngine;->extractW1(J)I

    move-result v3

    .line 251
    .local v3, "key1":I
    invoke-direct {p0, v8, v9}, Lorg/spongycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v4

    .line 252
    .local v4, "key2":I
    invoke-direct {p0, v8, v9}, Lorg/spongycastle/crypto/engines/SEEDEngine;->extractW1(J)I
    ...
    .line 261
    invoke-direct {p0, v6, v7}, Lorg/spongycastle/crypto/engines/SEEDEngine;->rotateRight8(J)J
    ...
    .line 267
    :cond_0
    invoke-direct {p0, v8, v9}, Lorg/spongycastle/crypto/engines/SEEDEngine;->rotateLeft8(J)J
...
.method public processBlock([BI[BI)I
    ...
    const-string v8, "SEED engine not initialised"
    ...
    const-string v8, "input buffer too short"

    invoke-direct {v1, v8}, Lorg/spongycastle/crypto/DataLengthException;-><init>(Ljava/lang/String;)V
    ...
    .line 212
    .local v6, "r":J
    iget-boolean v1, p0, Lorg/spongycastle/crypto/engines/SEEDEngine;->forEncryption:Z
    ...
    invoke-direct {p0, v1, v8, v6, v7}, Lorg/spongycastle/crypto/engines/SEEDEngine;->F(IIJ)J
    ...
    invoke-direct {p0, p3, v1, v6, v7}, Lorg/spongycastle/crypto/engines/SEEDEngine;->longToBytes([BIJ)V

    .line 234
    add-int/lit8 v1, p4, 0x8

    invoke-direct {p0, p3, v1, v2, v3}, Lorg/spongycastle/crypto/engines/SEEDEngine;->longToBytes([BIJ)V
