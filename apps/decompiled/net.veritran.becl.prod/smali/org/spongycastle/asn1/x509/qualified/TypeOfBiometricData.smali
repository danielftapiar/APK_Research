...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/spongycastle/asn1/x509/qualified/TypeOfBiometricData;->obj:Lorg/spongycastle/asn1/DEREncodable;
...
.method public constructor <init>(Lorg/spongycastle/asn1/DERObjectIdentifier;)V
    .locals 0
    .param p1, "BiometricDataID"    # Lorg/spongycastle/asn1/DERObjectIdentifier;
    ...
    .line 68
    iput-object p1, p0, Lorg/spongycastle/asn1/x509/qualified/TypeOfBiometricData;->obj:Lorg/spongycastle/asn1/DEREncodable;
...
.method public static getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/qualified/TypeOfBiometricData;
    ...
    :cond_1
    instance-of v3, p0, Lorg/spongycastle/asn1/DERInteger;

    if-eqz v3, :cond_2

    .line 40
    invoke-static {p0}, Lorg/spongycastle/asn1/DERInteger;->getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/DERInteger;

    move-result-object v2

    .line 41
    .local v2, "predefinedBiometricTypeObj":Lorg/spongycastle/asn1/DERInteger;
    ...
    .end local v2    # "predefinedBiometricTypeObj":Lorg/spongycastle/asn1/DERInteger;
    .restart local p0    # "obj":Ljava/lang/Object;
    :cond_2
    instance-of v3, p0, Lorg/spongycastle/asn1/DERObjectIdentifier;

    if-eqz v3, :cond_3

    .line 47
    invoke-static {p0}, Lorg/spongycastle/asn1/DERObjectIdentifier;->getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/DERObjectIdentifier;

    move-result-object v0

    .line 48
    .local v0, "BiometricDataID":Lorg/spongycastle/asn1/DERObjectIdentifier;
    new-instance p0, Lorg/spongycastle/asn1/x509/qualified/TypeOfBiometricData;

    .end local p0    # "obj":Ljava/lang/Object;
    invoke-direct {p0, v0}, Lorg/spongycastle/asn1/x509/qualified/TypeOfBiometricData;-><init>(Lorg/spongycastle/asn1/DERObjectIdentifier;)V

    goto :goto_0

    .line 51
    .end local v0    # "BiometricDataID":Lorg/spongycastle/asn1/DERObjectIdentifier;
    .restart local p0    # "obj":Ljava/lang/Object;
    :cond_3
...
# virtual methods
.method public getBiometricDataOid()Lorg/spongycastle/asn1/DERObjectIdentifier;
    .locals 1

    .prologue
    .line 83
    iget-object v0, p0, Lorg/spongycastle/asn1/x509/qualified/TypeOfBiometricData;->obj:Lorg/spongycastle/asn1/DEREncodable;
