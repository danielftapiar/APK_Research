.class public Lnet/veritran/vtuserapplication/processes/ProcessVTArray;
.super Ljava/lang/Object;


# instance fields
.field private a:Lnet/veritran/function/VTArrayFunction;


# direct methods
.method public constructor <init>(Lnet/veritran/vtuserapplication/configuration/elements/ConfigurationProcessFunctionVTArray;)V
    .locals 8
    ...
    new-instance v0, Lnet/veritran/function/VTArrayFunction;

    invoke-direct {v0}, Lnet/veritran/function/VTArrayFunction;-><init>()V

    iput-object v0, p0, Lnet/veritran/vtuserapplication/processes/ProcessVTArray;->a:Lnet/veritran/function/VTArrayFunction;

    const-string v0, "ProcessVTArrayUtils"

    const-string v1, "new VTArrayFunction()"

    invoke-static {v0, v1}, Lnet/veritran/vtuserapplication/utils/VTLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Lnet/veritran/vtuserapplication/configuration/elements/ConfigurationProcessFunctionVTArray;->getFuntionCalls()Ljava/util/List;

    move-result-object v0

    const-string v1, "ProcessVTArrayUtils"
    ...
    const-string v2, "ProcessVTArrayUtils"
    ...
    const-string v4, "ProcessVTArrayUtils"
    ...
    new-instance v4, Lnet/veritran/function/model/FArrayCall;

    invoke-direct {v4, v2, v3}, Lnet/veritran/function/model/FArrayCall;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5}, Lnet/veritran/function/model/FArrayCall;->addCallParam(Lnet/veritran/function/model/CallParam;)V

    goto :goto_1

    :cond_0
    iget-object v0, p0, Lnet/veritran/vtuserapplication/processes/ProcessVTArray;->a:Lnet/veritran/function/VTArrayFunction;

    invoke-virtual {v0, v4}, Lnet/veritran/function/VTArrayFunction;->addFCall(Lnet/veritran/function/model/IFCall;)V
...
.method public execute()V
    ...
    invoke-virtual {v0}, Lnet/veritran/function/VTArrayFunction;->execute()V
