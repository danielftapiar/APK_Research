.class public Lnet/veritran/vtuserapplication/processes/ProcessVTStringUtils;
.super Ljava/lang/Object;


# instance fields
.field private a:Lnet/veritran/function/VTStringUtilsFunction;


# direct methods
.method public constructor <init>(Lnet/veritran/vtuserapplication/configuration/elements/ConfigurationProcessFunctionVTStringUtils;)V
    .locals 8
    ...
    new-instance v0, Lnet/veritran/function/VTStringUtilsFunction;

    invoke-direct {v0}, Lnet/veritran/function/VTStringUtilsFunction;-><init>()V

    iput-object v0, p0, Lnet/veritran/vtuserapplication/processes/ProcessVTStringUtils;->a:Lnet/veritran/function/VTStringUtilsFunction;

    const-string v0, "ProcessVTStringUtils"

    const-string v1, "new VTStringUtilsFunction()"

    invoke-static {v0, v1}, Lnet/veritran/vtuserapplication/utils/VTLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Lnet/veritran/vtuserapplication/configuration/elements/ConfigurationProcessFunctionVTStringUtils;->getFuntionCalls()Ljava/util/List;

    move-result-object v0

    const-string v1, "ProcessVTStringUtils"
    ...
    const-string v2, "ProcessVTStringUtils"
    ...
    const-string v4, "ProcessVTStringUtils"
    ...
    new-instance v4, Lnet/veritran/function/model/FStringCall;

    invoke-direct {v4, v2, v3}, Lnet/veritran/function/model/FStringCall;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5}, Lnet/veritran/function/model/FStringCall;->addCallParam(Lnet/veritran/function/model/CallParam;)V

    goto :goto_1

    :cond_0
    iget-object v0, p0, Lnet/veritran/vtuserapplication/processes/ProcessVTStringUtils;->a:Lnet/veritran/function/VTStringUtilsFunction;

    invoke-virtual {v0, v4}, Lnet/veritran/function/VTStringUtilsFunction;->addFCall(Lnet/veritran/function/model/IFCall;)V
...
.method public execute()V
    ...
    invoke-virtual {v0}, Lnet/veritran/function/VTStringUtilsFunction;->execute()V
